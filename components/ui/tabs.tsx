...
const TabsList = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.List> & { orientation?: string }
>(({ className, orientation = 'horizontal', ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "items-center justify-start rounded-md bg-muted p-1 text-muted-foreground",
      orientation == 'vertical' ? "flex flex-col h-auto justify-start" : "inline-flex h-10 justify-center",
      className
    )}
    {...props}
  />
