...
export function WidgetBrawer() {
  ...
  const { mutate: addWidget } = useAddWidget(houseBuild?.address || "");

  const [imageGrid, setImageGrid] = useState({ col: 4, row: 6 });
  const [boardGrid, setBoardGrid] = useState({ col: 4, row: 6 });
  const [postGrid, setPostGrid] = useState({ col: 4, row: 6 });
  const [emptyGrid, setEmptyGrid] = useState({ col: 4, row: 6 });

  if (!houseBuild || !houseId) {
    return false;
  }
  ...
  const handleAddWidget = (
    ...
    const widgetCount = houseBuild.widget.length;
    const x = (widgetCount * grid.col) % 12;
    const y = Math.floor((widgetCount * grid.col) / 12) * grid.row;
  ...
  const sampleBoardId = houseBuild.board.filter(
    (item) => item.type == "post"
  )[0]?.id;
          ...
          <div className="">
            <Tabs defaultValue="image" className="flex justify-start">
              <TabsList orientation="vertical">
                <TabsTrigger className="w-32 text-start" value="image">
                  이미지
                </TabsTrigger>
                <TabsTrigger className="w-32 text-start" value="board">
                  룸
                </TabsTrigger>
                <TabsTrigger className="w-32 text-start" value="post">
                  포스트
                </TabsTrigger>
                <TabsTrigger className="w-32 text-start" value="profile">
                  프로필
                </TabsTrigger>
                <TabsTrigger className="w-32 text-start" value="timer">
                  타이머
                </TabsTrigger>
                <TabsTrigger className="w-32 text-start" value="empty">
                  공백
                </TabsTrigger>
              </TabsList>
                  ...
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] flex items-center">
                      <div
                        ...
                        onClick={() =>
                          handleAddWidget("image", { col: 2, row: 3 })
                        }
                      >
                        <WidgetImage />
                  ...
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] flex items-center">
                      <div
                        ...
                        onClick={() =>
                          handleAddWidget("image", { col: 4, row: 3 })
                        }
                      >
                        <WidgetImage />
                        <button className="hidden group-hover:block absolute z-[999999] -left-1.5 -top-1.5 bg-green-400 rounded-full p-1">
                  ...
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] w-2/3 flex flex-col justify-center items-center text-center gap-y-2">
                      <Select
                        ...
                        onValueChange={(value) =>
                          setImageGrid({ ...imageGrid, col: parseInt(value) })
                        }
                      >
                        <SelectTrigger>
                        ...
                        <SelectContent>
                          {Array.from(
                            ...
                            <SelectItem key={col} value={String(col * 2)}>
                              Col : {col}
                            </SelectItem>
                          ))}
                        </SelectContent>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setImageGrid({ ...imageGrid, row: parseInt(value) })
                        }
                      >
                        <SelectTrigger>
                        ...
                        <SelectContent>
                          {Array.from(
                            ...
                            <SelectItem key={row} value={String(row * 3)}>
                              Row : {row}
                            </SelectItem>
                          ))}
                        </SelectContent>
              ...
              <TabsContent value="board" className="w-full">
                <div className="grid grid-cols-3">
                      ...
                      <div
                        ...
                        onClick={() =>
                          handleAddWidget(
                            "board",
                            { col: 4, row: 6 },
                            { option_id: sampleBoardId, option_bool: true }
                          )
                        }
                      >
                        <WidgetBoard
                          widget={{
                            option_id: sampleBoardId,
                            option_bool: true,
                          }}
                        />
                        <button className="hidden group-hover:block absolute z-[999999] -left-1.5 -top-1.5 bg-green-400 rounded-full p-1">
                  ...
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] w-2/3 flex flex-col justify-center items-center text-center gap-y-2">
                      <Select
                        defaultValue={String(boardGrid.col)}
                        onValueChange={(value) =>
                          setBoardGrid({ ...boardGrid, col: parseInt(value) })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="col" />
                      ...
                      x
                      <Select
                        defaultValue={String(boardGrid.row)}
                        onValueChange={(value) =>
                          setBoardGrid({ ...boardGrid, row: parseInt(value) })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="row" />
                  ...
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] flex items-center">
                      <div
                        className="w-[282px] h-[286px] scale-75 custom-card rounded-md text-card-foreground"
                        onClick={() =>
                          handleAddWidget("post", { col: 4, row: 6 })
                        }
                      >
                    ...
                    <p className="font-bold text-sm mb-2">포스트형 2x2</p>
                  </div>
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] w-2/3 flex flex-col justify-center items-center text-center gap-y-2">
                      <Select
                        defaultValue={String(postGrid.col)}
                        onValueChange={(value) =>
                          setPostGrid({ ...postGrid, col: parseInt(value) })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="col" />
                      ...
                      x
                      <Select
                        defaultValue={String(postGrid.row)}
                        onValueChange={(value) =>
                          setPostGrid({ ...postGrid, row: parseInt(value) })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="row" />
                  ...
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] flex items-center">
                      <div
                        className="w-[282px] h-[130px] scale-75 custom-card rounded-md text-card-foreground"
                        onClick={() =>
                          handleAddWidget("profile", { col: 4, row: 3 })
                        }
                      >
                  ...
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] flex items-center">
                      <div
                        ...
                        onClick={() =>
                          handleAddWidget("profile", { col: 4, row: 6 })
                        }
                      >
                  ...
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] flex items-center">
                      <div
                        className="w-[282px] h-[130px] scale-75 custom-card rounded-md text-card-foreground"
                        onClick={() =>
                          handleAddWidget("timer", { col: 4, row: 3 })
                        }
                      >
                        <WidgetTimer />
                        <button className="hidden group-hover:block absolute z-[999999] -left-1.5 -top-1.5 bg-green-400 rounded-full p-1">
                    ...
                    <p className="font-bold text-sm mb-2">타이��� 2x1</p>
                  </div>
                </div>
              </TabsContent>
              <TabsContent value="empty">
                <div className="grid grid-cols-3">
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] flex items-center">
                      <div
                        ...
                        onClick={() =>
                          handleAddWidget("empty", { col: 2, row: 3 })
                        }
                      >
                        <WidgetEmpty />
                        <button className="hidden group-hover:block absolute z-[999999] -left-1.5 -top-1.5 bg-green-400 rounded-full p-1">
                  ...
                  <div className="group relative flex flex-col items-center">
                    <div
                      className="h-[286px] flex items-center"
                      onClick={() =>
                        handleAddWidget("empty", { col: 4, row: 3 })
                      }
                    >
                      <div
                  ...
                  <div className="group relative flex flex-col items-center">
                    <div className="h-[286px] w-2/3 flex flex-col justify-center items-center text-center gap-y-2">
                      <Select
                        ...
                        onValueChange={(value) =>
                          setEmptyGrid({ ...emptyGrid, col: parseInt(value) })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="col" />
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setEmptyGrid({ ...emptyGrid, row: parseInt(value) })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="row" />
