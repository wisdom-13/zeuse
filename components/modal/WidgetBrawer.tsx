          ...
          <div className=''>
            <Tabs defaultValue='image' className='flex justify-start'>
              <TabsList orientation='vertical'>
                ...
                <TabsTrigger className='w-32 text-start' value='board'>룸</TabsTrigger>
                <TabsTrigger className='w-32 text-start' value='post'>포스트</TabsTrigger>
                  ...
                  <div className='group relative flex flex-col items-center'>
                    <div className='h-[286px] w-2/3 flex flex-col justify-center items-center text-center gap-y-2'>
                      <Select
                        ...
                        onValueChange={(value) => setImageGrid({ ...imageGrid, col: parseInt(value) })}
                      >
                        <SelectTrigger>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setImageGrid({ ...imageGrid, row: parseInt(value) })}
                      >
                        <SelectTrigger>
                ...
                <div className='grid grid-cols-3'>
                  <div className='group relative flex flex-col items-center'>
                    <div className='h-[286px] flex items-center'>
                      ...
                      >
                        <WidgetBoard widget={{ option_id: sampleBoardId, option_bool: true }} />
                        <button className='hidden group-hover:block absolute z-[999999] -left-1.5 -top-1.5 bg-green-400 rounded-full p-1'>
                          <Plus size={16} className='text-white' />
                        </button>
                      </div>
                  ...
                  <div className='group relative flex flex-col items-center'>
                    <div className='h-[286px] w-2/3 flex flex-col justify-center items-center text-center gap-y-2'>
                      <Select
                        ...
                        onValueChange={(value) => setBoardGrid({ ...boardGrid, col: parseInt(value) })}
                      >
                        <SelectTrigger>
                          <SelectValue placeholder='col' />
                        </SelectTrigger>
                        <SelectContent>
                          {Array.from({ length: 5 }, (_, index) => index + 2).map(col => (
                            <SelectItem key={col} value={String(col * 2)}>Col : {col}</SelectItem>
                          ))}
                        </SelectContent>
                      </Select>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setBoardGrid({ ...boardGrid, row: parseInt(value) })}
                      >
                        <SelectTrigger>
                          <SelectValue placeholder='row' />
                        </SelectTrigger>
                        <SelectContent>
                          {Array.from({ length: 3 }, (_, index) => index + 2).map(row => (
                            <SelectItem key={row} value={String(row * 3)}>Row : {row}</SelectItem>
                          ))}
                        </SelectContent>
                      </Select>
                  ...
                  <div className='group relative flex flex-col items-center'>
                    <div className='h-[286px] w-2/3 flex flex-col justify-center items-center text-center gap-y-2'>
                      <Select
                        ...
                        onValueChange={(value) => setPostGrid({ ...postGrid, col: parseInt(value) })}
                      >
                        <SelectTrigger>
                          <SelectValue placeholder='col' />
                        </SelectTrigger>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setPostGrid({ ...postGrid, row: parseInt(value) })}
                      >
                        <SelectTrigger>
                          <SelectValue placeholder='row' />
                        </SelectTrigger>
                      ...
                      <Button
                        className='w-full'
                        onClick={() => handleAddWidget('post', { col: postGrid.col, row: postGrid.row })}
                      >
                        추가
                      </Button>
                    </div>
